...
| **10** | Mar 18 | RL for Robotics (Embodied RL) | Continuous control policies, sim-to-real transfer, domain randomization, hybrid IL + RL strategies | [lecture10]({{ '/assets/lectures/lecture10_compressed.pdf' | relative_url }}) |
